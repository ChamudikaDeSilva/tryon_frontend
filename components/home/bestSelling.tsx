  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 text-center z-[999]">
        ...
        <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight uppercase text-white">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-red-600 to-slate-400">
            Top Sellers
          </span>
        </h2>
      </div>
      ...
      {products.map((product, index) => (
        ...
        >
          ...
          <div className="text-center space-y-3">
            ...
            <button className="mt-6 px-8 py-3 border border-white/30 rounded-full hover:bg-white hover:text-black transition">
              View Details
            </button>
          </div>
        </div>
