...
export async function handleRegister(data: RegisterFormData): Promise<{ success: boolean; error?: string }> {
...
export async function handleLogin(data: LoginFormData): Promise<{ success: boolean; error?: string; token?: string }> {
